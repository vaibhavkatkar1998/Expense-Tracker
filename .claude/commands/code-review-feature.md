...
- Source files to reference: `src/main/java/com/spendly/controller/`,
  `src/main/java/com/spendly/service/`, and
...
- Source files to reference: `src/main/java/com/spendly/controller/`,
  ...
  `src/main/java/com/spendly/repository/`, and
  `src/main/resources/templates/`
- Instruction: Review only the changed code for quality, 
  Spring Boot best practices, and maintainability. Do not 
